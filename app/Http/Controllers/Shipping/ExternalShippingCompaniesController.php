...
class ExternalShippingCompaniesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $external_shipping_companies->where('shipping_company_id',shipping()->id);
      
        $external_shipping_companies=$external_shipping_companies->paginate(15);
        return inertia('ShippingCompany/Companies/Index',['external_shipping_companies'=>$external_shipping_companies])->with(['page_name'=>$this->index_page_name]);
    ...
    public function create()
    {
        ...
        return inertia('ShippingCompany/Companies/Create')->with(['page_name'=>$this->create_page_name]);
    ...
    {   
        ...
        if(shipping()){
            $data['shipping_company_id']=shipping()->id;
        }
        
        $external_shipping_company=ExternalShippingCompany::create($data);
        return redirect()->route('externa_shipping_companies.index')->with('success',__('item created successfully'));
    }
    ...
    public function edit(ExternalShippingCompany $external_shipping_company)
    {
        ...
        return inertia('ShippingCompany/Companies/Edit',compact('external_shipping_company'))->with(['page_name'=>$this->edit_page_name]);
    ...
    public function update(Request $request, collection $external_shipping_company)
    {
        ...
        return redirect()->route('externa_shipping_companies.index')->with('success',__('item updated successfully'));
    }
    ...
    public function destroy(ExternalShippingCompany $external_shipping_company)
    {
        ...
        return redirect()->route('externa_shipping_companies.index')->with('success',__('item deleted successfully'));
    }
    ...
    public function multi_destroy(Request $request)
    {
        if(count($request->checked)>0){
            ...
            return redirect()->route('externa_shipping_companies.index');
        }
    }
