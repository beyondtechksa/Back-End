...
class BigdartDriver implements CompanyDriverInterface
{

    public function extract($category,$type='scrap')
    {
        $company_name=CompanyEnums::BIGDART;
        $xml = fetchDataFromUrl("https://cdn1.xmlbankasi.com/p1/bigdartr/image/data/xml/standart.xml");
        ...
        $product=$productsData->Product[1];
        return $product;
