...
class MiteloveDriver implements CompanyDriverInterface
{
    public function extract($category,$type='scrap')
    {
        $company_name=CompanyEnums::MITELOVE;
        $xml = fetchDataFromUrl("http://www.mitelove.com/TicimaxXmlV2/7A162C1B03DF4F839D8C167DF5C3CDBA/");
