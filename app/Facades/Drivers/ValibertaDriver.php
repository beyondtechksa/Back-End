...
class ValibertaDriver implements CompanyDriverInterface
{
    public function extract($category,$type='scrap')
    {
        $company_name=CompanyEnums::VALIBERTA;
        $xml = fetchDataFromUrl("https://www.valiberta.com/TicimaxXmlV2/CA92629CEF05465E93A1EAD4F362C199/");
