    ...
    <app>
        <div class="shop-filter-option">
            ...
            <div class="product-filter filterbutton ">
                <a href="javascript:void(0)" class="shopFilterButton active-btn d-flex" data-bs-toggle="offcanvas"
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight">
            ...
            <div class="offcanvas-body">
                <div class="filter-top-heading">
                    <h3 class="gap-1 d-flex align-items-center">
                            ...
                            <div class="accordion-body">
                                <div class="list">
                                    <form class="d-flex position-relative" role="search">
                                        <div class="gap-2 search-input d-flex align-items-center"
                                             style="height: 43px;padding: 0 8px;">
                                            <img src="/home/img/search.svg" alt="" class="">

                                            <input v-model="search_categories" class="" type="search"
                                    ...
                                    <ul class="py-3">
                                        <li class="level1" v-for="(category,index) in filteredCategories"
                                            :key="index">
                                            <label @click="toggle_select_category(category)"
                                                   class="main-category d-flex justify-content-between"
                                                   :for="'category-check'+index">
                                                <span> {{ category.translated_name }} </span>
                                                <span v-if="check_opened_category(category)"> <i
                                            ...
                                            <ul v-if="category.children && category.children.length>0 && check_opened_category(category)">
                                                <li v-for="(sub, subIndex) in category.children"
                                                    ...
                                                    <div v-if="sub.children && sub.children.length > 0 ">
                                                        <label @click="toggle_select_category(sub)"
                                                               class="main-category d-flex justify-content-between"
                                                               :for="'subcategory-check' + index + '-' + subIndex">
                                                            <span> {{ sub.translated_name }} </span>
                                                            <span v-if="check_opened_category(sub)"> <i
                                                                class="fa fa-chevron-up"></i> </span>
                                                            <span v-else> <i class="fa fa-chevron-down"></i> </span>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <ul v-show="check_opened_category(sub)">
                                                        <li v-for="(subTwo, subIndexTwo) in sub.children"
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class="badge bg-dark">{{ subTwo.products_count }}</span>
                                                            </div>
                                                            <ul v-show="check_opened_category(subTwo)">
                                                                <li v-for="(subThree, subIndexThree) in subTwo.children"
                                                                    :key="subIndexThree">
                                                                    <div
                                                                        v-if="subThree.children && subThree.children.length > 0">
                                                                        <label @click="toggle_select_category(subThree)"
                                                                               class="main-category d-flex justify-content-between"
                                                                               :for="'subThreeCategory-check' + index + '-' + subIndex + '-' + subIndexTwo + '-' + subIndexThree">
                                                                            <span> {{
                                                                                    subThree.translated_name
                                                                                }} </span>
                                                                            <span
                                                                                v-if="check_opened_category(subThree)"> <i
                                                                                class="fa fa-chevron-up"></i> </span>
                                                                            <span v-else> <i
                                                                                class="fa fa-chevron-down"></i> </span>
                                                                        </label>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="badge bg-dark">{{ subThree.products_count }}</span>
                                                                    </div>
                            ...
                            <div class="accordion-body">
                                <div class="color-filter">
                                    <form action="" class="pt-2 ps-2">
                                        <div class="color-box">
                                            <a v-for="color,index in colors" href="javascript:void(0)"
                                               @click="filter_data.color=color.id">
                                                <span class="sm-box" :style="{ background: color.color_code }"></span>
                        ...
                        >
                            <div class="accordion-body">
                                <div class="wrapper">
                                    ...
                                    <div class="px-2 mt-3">
                                        <Slider @mouseup="handleRangeInputMouseDown" v-model="filter_data.discount"
                        ...
                        >
                            <div class="accordion-body">
                                <div class="size-filter">
                                    <form action="" class="pt-2 ps-2">
                                        <div class="size-box">
                                            <a v-for="size,index in sizes" href="javascript:void(0)"
                                               @click="filter_data.size=size.id">{{ size.translated_name }}</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        >
                            <div class="accordion-body">
                                <div class="wrapper">
                                    ...
                                    <div class="px-2 mt-3">
                                        <Slider @mouseup="handleRangeInputMouseDown" v-model="filter_data.price"
                                                :min="0" :max="10000" :range="true"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            >
                                                <div class="accordion-body">
                                                    <form class="d-flex position-relative" role="search">
                                                        <div class="gap-2 search-input d-flex align-items-center"
                                                             style="height: 43px; padding: 0px 8px;">
                                                            <img src="/home/img/search.svg" alt="" class="">
                                                            <input v-model="search_brands" class="" type="search"
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            >
                                                <div class="accordion-body">
                                                    <div class="wrapper">
                                                        <div class="px-2 mt-3">
                                                            <Slider @mouseup="handleRangeInputMouseDown"
                                                                    v-model="filter_data.discount" :min="0" :max="100"
                                                                    :range="true"/>
                                                        </div>
                                                        <!-- <div class="price-input">
                                                            <div class="field">
                                                                ...
                                                                <input
                                                                    ...
                                                                    class="input-min"
                                                                    value="0"
                                                                    @mouseup="handleRangeInputMouseDown"
                                                                />
                                                            </div>
                                                        ...
                                                        <div class="range-input">
                                                            <input
                                                                ...
                                                                min="0"
                                                                max="100"
                                                                v-model="filter_data.discount.min"
                                                                step="100"
                                                                @mouseup="handleRangeInputMouseDown"
                                                            />
                                                            <input
                                                                ...
                                                                min="0"
                                                                max="100"
                                                                v-model="filter_data.discount.max"
                                                                step="100"
                                                                @mouseup="handleRangeInputMouseDown"
                                                            />
                                                        </div> -->
                                                ...
                                                <div class="accordion-body">
                                                    <div class="size-filter">
                                                        <form action="" class="pt-2 ps-2">
                                                            <div class="size-box">
                                                                <a v-for="size,index in sizes" href="javascript:void(0)"
                                                                   @click="filter_data.size=size.id">{{
                                            ...
                                            >
                                                <div class="accordion-body">
                                                    <div class="wrapper">
                                                        <div class="px-2 mt-3">
                                                            <Slider @mouseup="handleRangeInputMouseDown"
                                                                    v-model="filter_data.price" :min="0" :max="10000"
                                                                    :range="true"/>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-xl-9 col-lg-8">
                                <div class="shop-right-container">
                                    <div class="shop-right-heading-content d-lg-block">
                                        <div class="mb-3 shop-head-title">
                                            <h2>
                                                <span class="mx-2 number"> {{ products.length }} </span>
                                    ...
                                    <!-- <div class="text-center">
                                        <img class="collection-img" :src="collection.translated_image">
                                    </div> -->
                                    ...
                                    <div class="row firstDiv">
                                        ...
                                        <div id="load-more-box" ref="loadMoreBox" class="text-center w-100"
...
export default {
    ...
    mounted() {
        ...
        this.filter_data.slug = this.slug
        this.previousFilterData.slug = this.slug
    },
    methods: {
        filter() {
        ...
        load_more() {
            ...
            setTimeout((e) => {
                ...
                // this.filter_data.offset += this.filter_data.limit;
        ...
        /*getBrands() {
             axios.get('/api/brands').then(res => {
                    this.filteredBrands  = res.data.data ;
             }).catch(err => {
