<template>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <span> {{ slug }} </span>
            <span @click="new_item()" data-bs-target="#newModal" data-bs-toggle="modal" class="btn btn-primary"> <i class="ri-add-line"></i> {{ __('new') }} </span>
        </div>
        <div class="card-body">
            ...
            <div class="row position-relative">
                ...
                <div class="col-6" v-for="locale,index2 in $page.props.locales" :key="index2">
                    <label class="form-label"> {{ __('slider in mobile') }}  ({{ locale.symbol }})  <span class="text-success"></span> </label>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="mobile_banner,index in mobile_banners" :key="index" v-show="vform.category_id==mobile_banner.category_id">
                            <th>
                            <img v-if="mobile_banner.images" style="width:100px" v-lazy="mobile_banner.images.en">
                            </th>
                            <th>
                                <img v-if="mobile_banner.images" style="width:100px" v-lazy="mobile_banner.images.ar">
                            </th>
  ...
  props:{mobile_banners:Object,slug:String,category_id:String,collections:Array,categories:Array},
    ...
    methods:{
        ...
        check_src(lang){
            ...
            if(this.vform.images[lang]!=null){
                return this.vform.images[lang]
            }else{
        ...
        fileUploaded(){
                this.vform.images[this.lang]=this.$refs.gallery.selected_media.path
        },
