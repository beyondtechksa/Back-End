    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row position-relative" v-for="val,index in form.value" :key="index">
                ...
                <div class="col-12">
                    <div class="mb-3">
                    <label class="form-label"> {{__('brand Link')}} {{index+1}} </label>
                ...
                <div class="col-12">
                    ...
                    <div  v-for="locale,index2 in $page.props.locales" :key="index2">
                        <label class="form-label"> {{ __('brand text') }} {{index+1}} ({{ locale.symbol }}) </label>
                ...
                <div class="col-6"  v-for="locale,index2 in $page.props.locales" :key="index2">
                    <label class="form-label"> {{ __('brand image') }} {{index+1}} ({{ locale.symbol }}) <span class="text-success"> h:flexible </span> </label>
