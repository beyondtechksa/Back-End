    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row position-relative" v-for="val,index in form.value" :key="index">
                ...
                <div class="col-12">
                    <div class="mb-3">
                    <label class="form-label"> {{__('banner Link')}} {{index+1}} </label>
                ...
                <div class="col-12">
                    ...
                    <div  v-for="locale,index2 in $page.props.locales" :key="index2">
                        <label class="form-label"> {{ __('banner text') }} {{index+1}} ({{ locale.symbol }}) </label>
                ...
                <div class="col-6">
                    <label class="form-label"> {{ __('banner image') }} {{index+1}} <span class="text-success"> h:flexible </span> </label>
