  ...
  data(){
    return {
        form:useForm({
            ...
            reference:this.voucher.reference,
            reference_details:this.voucher.reference_details,
            currency_id:this.voucher.currency_id,
            amount:this.voucher.amount,
            valid_untill:this.voucher.valid_untill,
            status:this.voucher.status==1?true:false,
        }),
    }
  },
  methods:{
        edit(){
                this.form.put(route('vouchers.update',this.voucher.id))
            },
