                                ...
                                <div class="col-12">
                                  ...
                                  <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input :placeholder="__('enter admin name')" :class="{ 'is-invalid': errors.name } " v-model="form.name" class="form-control border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-lg" >
                                  ...
                                  <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input :placeholder="__('enter password')" autocomplete="new-password" type="password" :class="{ 'is-invalid': errors.password } " v-model="form.password" class="form-control border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-lg" >
                                  ...
                                  <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input :placeholder="__('confirm password')"  type="password" :class="{ 'is-invalid': errors.password_confirmation } " v-model="form.password_confirmation" class="form-control border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-lg" >
                                    </div>
                                    </div>
    ...
    methods:{
        ...
        close(){
            if(this.form.name || this.form.email){
                if(confirm('You are leaving the page')){
