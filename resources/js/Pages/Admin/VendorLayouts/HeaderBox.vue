                       ...
                       data-bs-auto-close="outside" aria-expanded="false">
                        <div class="d-flex align-items-center">
                            <div class="me-sm-2 me-0">
                                <img v-if="$page.props.auth.vendor" v-lazy="$page.props.auth.vendor.image" alt="img"
...
export default {
    ...
    methods: {
        logout() {
            this.form.post(route('vendor.logout'))
        },
        collapse_menu() {
        ...
        loadNotifications() {
            axios.get(route('vendor.notifications'))
                .then((resp) => {
        ...
        markAsRead(id) {
            axios.put(route('vendor.mark.read', id))
                .then((response) => {
