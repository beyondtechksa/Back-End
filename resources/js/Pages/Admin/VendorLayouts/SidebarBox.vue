<template>
  ...
  <div class="main-sidebar" id="sidebar-scroll">
      ...
      <nav class="main-menu-container nav nav-pills flex-column sub-open">
          ...
          <ul class="main-menu">
              ...
              <!-- End::slide__category -->
              <li class="slide">
                  <Link :href="route('vendor.dashboard')" class="side-menu__item">
                      <i class="ri-home-3-line side-menu__icon"></i>
                      <span class="side-menu__label"> {{ __('home') }} </span>
                  </Link>
              </li>
              <li class="slide">
                  <Link :href="route('vendor.order_requests',0)" class="side-menu__item">
                      <i class="ri-home-3-line side-menu__icon"></i>
              ...
              <li class="slide">
                  <Link :href="route('vendor.order_requests')" class="side-menu__item">
                      <i class="ri-home-3-line side-menu__icon"></i>
                      <span class="side-menu__label"> {{ __('All Orders') }} </span>
                  </Link>
              </li>
              <li class="slide">
                  <Link :href="route('vendor.order_requests',2)" class="side-menu__item">
                      <i class="ri-home-3-line side-menu__icon"></i>
                      <span class="side-menu__label"> {{ __('Accepted Orders') }} </span>
                  </Link>
              </li>
              <li class="slide">
                  <Link :href="route('vendor.order_requests',1)" class="side-menu__item">
                      <i class="ri-home-3-line side-menu__icon"></i>
                      <span class="side-menu__label"> {{ __('Refused Orders') }} </span>
                  </Link>
              </li>
              <li class="slide">
                  <Link :href="route('external_shipping_companies.index')" class="side-menu__item">
                      <i class="ri-home-3-line side-menu__icon"></i>
  ...
  // for menu scroll to top active page
      ...
      methods:{
        get_pending_orders(){
          axios.get('/vendor/get_pending_orders')
               .then((resp)=>{
