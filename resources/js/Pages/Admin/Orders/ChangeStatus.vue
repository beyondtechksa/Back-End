    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button @click="change_status(3)" class="btn btn-warning w-100 mb-2">  processing</button>
                <button @click="change_status(4)" class="btn btn-info w-100 mb-2">  shipping</button>
                <button @click="change_status(5)" class="btn btn-success w-100 mb-2">  delivered</button>
            </div>
