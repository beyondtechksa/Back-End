            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input :placeholder="__('enter role name')" v-model="form.name" type="text" class="form-control" :class="{ 'is-invalid': errors.name } " >
                    ...
                    <div class="col-lg-12">
                        <div class="hstack gap-2">
                            <button :disabled="form.processing || form.permissions.length==0" type="submit" class="btn btn-primary btn-md"><i class="ri-save-line fs-16 align-middle d-inline-block"></i> {{__('create')}}  </button>
                        </div>
                    </div>
                </div>
                </form>
...
export default {
  components: { AuthLayout, PageHeader, useForm},
  props:{
    errors:Object,
    permissions:Array,
  },
