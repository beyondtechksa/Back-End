<template>
  ...
  <div class="main-sidebar-header">
      <Link href="/shipping/dashboard" class="header-logo">
  ...
  <div class="main-sidebar" id="sidebar-scroll">
      ...
      <nav class="main-menu-container nav nav-pills flex-column sub-open">
          ...
          <ul class="main-menu">
              ...
              <!-- End::slide__category -->
              <li class="slide">
                  <Link :href="route('shipping.dashboard')" class="side-menu__item">
                      <i class="ri-home-3-line side-menu__icon"></i>
                      <span class="side-menu__label"> {{ __('home') }} </span>
                  </Link>
              </li>
              <li class="slide">
                  <Link :href="route('shipping.orders',2)" class="side-menu__item">
                      <i class="ri-home-3-line side-menu__icon"></i>
                      <span class="side-menu__label mx-2"> {{ __('New Orders') }} </span>
                      <span class="badge bg-primary"> {{new_orders}} </span>
                  </Link>
              </li>
              <li class="slide">
                <Link :href="route('shipping.orders')" class="side-menu__item">
                  <i class="ri-home-3-line side-menu__icon"></i>
                  <span class="side-menu__label"> {{ __('All Orders') }} </span>
                </Link>
              </li>
              <li class="slide">
                  <Link :href="route('shipping.orders','pending')" class="side-menu__item">
                      <i class="ri-home-3-line side-menu__icon"></i>
                      <span class="side-menu__label mx-2"> {{ __('Pending Orders') }} </span>

                  </Link>
              </li>
              <li class="slide">
                  <Link :href="route('shipping.orders',6)" class="side-menu__item">
                      <i class="ri-home-3-line side-menu__icon"></i>
                      <span class="side-menu__label"> {{ __('Completed Orders') }} </span>
                  </Link>
              </li>
              <li class="slide">
                  <Link :href="route('externa_shipping_companies.index')" class="side-menu__item">
                      <i class="ri-home-3-line side-menu__icon"></i>
  ...
  // for menu scroll to top active page
      ...
      methods:{
        get_pending_orders(){
          axios.get('/shipping/get_pending_orders')
               .then((resp)=>{
                this.new_orders=resp.data
               })
        }
      }
