  ...
  data(){
    return {
        form:useForm({
            ...
            reference:this.coupon.reference,
            reference_details:this.coupon.reference_details,
            discount_type:this.coupon.discount_type,
            coupon_type:this.coupon.coupon_type,
            discount_amount:this.coupon.discount_amount,
            valid_untill:this.coupon.valid_untill,
            status:this.coupon.status==1?true:false,
        }),
    }
  },
  methods:{
