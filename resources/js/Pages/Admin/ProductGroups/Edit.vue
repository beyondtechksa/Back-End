  ...
  data(){
    return {
        form:useForm({
            ...
            desc:this.product_group.desc,
            period:this.product_group.period,
            status:this.product_group.status==1?true:false,
        }),
    }
  },
  methods:{
        edit(){
                this.form.put(route('product_groups.update',this.product_group.id))
            },
