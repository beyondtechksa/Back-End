...
export default {
  ...
  props:{
    errors:Object,
    external_shipping_company:Object,
  },
  data(){
    return {
        form:useForm({
            name:this.external_shipping_company.name,
            link:this.external_shipping_company.link,
            image:this.external_shipping_company.image,
        }),
    }
  },
  methods:{
        edit(){
                this.form.put(route('external_shipping_companies.update',this.external_shipping_company.id))
            },
